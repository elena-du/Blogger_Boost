                     ...
                     html.Div(className='row',
                              children=[
                                  html.Div(className='twelve columns div-user-controls', 
                                      children = [
                                          html.H1('GET BETTER BLOGGING EXPERIENCE: find like-minded bloggers and explore emotional blueprint of your writing'), 
                                          html.Br(),
                                          html.Br(),
                                           ...
                                           children=[
                                               html.Img(src='https://upload.wikimedia.org/wikipedia/commons/3/31/Blogger.svg', 
                                                        ...
                                                        style = {'height':'25%','width':'25%', 
                                                                 'float':'right', "position":"absolute; TOP:35px; LEFT:170px; WIDTH:50px; HEIGHT:50px",
                                                                 'padding-top': 0, 'padding-right': 0}),
                                               html.Br(),
                                               html.Br(),
                                               html.H2('MY COMMUNITY'),
                                               html.H4('Select one or more key topics.'),
                              ...
                              children = [
                                  html.Div(className='four columns div-user-controls',
                                      children = [
                                          ...
                                          html.Br(),
                                          html.Br(),
                                          html.H2('MY DICTIONARY'),
                                          html.H4('Looking for a right word?'),
                                          html.H4('Explore your personal dictionary.'),
                                          html.Br(),
                                          html.Br(),
                                          html.Br(),
                                          html.H4('When I write...'),
                                          html.Br(),
                                          dcc.Input(id='input2', type='text', placeholder='Enter a word'),
                                          html.Br(),
                                          html.Br(),
                                          html.H4('I am thinking...'),
                                          html.Br(),
                                          html.Div(id="my_vocab", style={'color': '#AFF0C0', 'font-size': '1.6em'})
                                          ]),
                                  html.Div(className='eight columns div-user-controls',
                                      children = [
                                          ...
                                          html.Br(),
                                          html.Br(),
                                          html.H4('When I am talking about...'),
                                          html.Br(),
                                          dcc.Input(id='input3', type='text', placeholder='Enter a word'),
                                          html.H4('but I do not really mean ...'),
                                          dcc.Input(id='input4', type='text', placeholder='Enter a word'),
                                          html.Br(),
                                          html.Br(),
                                          html.H4('I am thinking...'),
                                          html.Br(),
                                          html.Div(id="my_vocab2", style={'color': '#AFF0C0', 'font-size': '1.6em'})
                                          ])]),
                     html.Br(),
                     html.Br(),
                     html.Br(),
                              ...
                              children=[
                                  html.Div(className='four columns div-user-controls',
                                      children=[
                                         ...
                                         html.Br(),
                                         html.H2('MY EMOTIONS'),
                                         html.H4('According to a famous psychologist Robert Plutchik there are 8 primary emotions.'),
                                         html.H4('Select one or more emotions. Observe the history of expressing these emotions in your blog.'),
                                         html.Div(
                              ...
                              children=[
                                  html.Div(className='four columns div-user-controls',
                                      children=[
                                         ...
                                         html.H4('Explore how negative or how positive you go from month to month in your posts.'),
                                         html.H4('Find your joyful and moody time of the year.'),
                                         html.Div(
                                             className='div-for-dropdown',
                              ...
                              children=[
                                  html.Div(className='four columns div-user-controls',
                                      children=[
                                         ...
                                         html.H4('Predict future amount of positivity and negativity in your posts based on past writing.'),
                                         html.H4('See if your posts are getting more positive or negative over time.'),
                                         html.H4('Plan the best time to write a joyful or an empathic post.'),
                                         html.Div(
                                             className='div-for-dropdown',
...
def update_graph(selected_checklist_value, input1):
    ...
    for topic in selected_checklist_value:
        trace.append(go.Scatter3d(x=df_sub[df_sub['Prime Topic'] == topic]['xs'],
                                 ...
                                 opacity=0.4,
                                 name=topic,
                                 text="I am " + df_sub[df_sub['Prime Topic'] == topic]['age'] + 
                                         " and " + df_sub[df_sub['Prime Topic'] == topic]['gender'] +
                                         ". My occupation is " + df_sub[df_sub['Prime Topic'] == topic]['occupation'] +
                                         ". Search me by ID " +
                                         df_sub[df_sub['Prime Topic'] == topic]['blogger_id']
                                         ,
    ...
    trace_extra = go.Scatter3d(x=df_sub[df_sub['blogger_id'] == input1]['xs'],
                    ...
                    marker = dict(size=20, color='#F23B0A',
                                  ...
                                  opacity=0.99),
                    text="It's ME " + df_sub[df_sub['blogger_id'] == input1]['blogger_id'],
    ...
    figure = {'data': data,
              'layout': go.Layout(
                  ...
                  height=1000,
                  autosize=True,
                  title={'text': 'BLOGGER.COM COMMUNITIES', 'font': {'color': 'white', 'size':28}, 'x': 0.5},
...
@app.callback(
    Output("my_vocab", "children"),
    [Input("input2", "value"), 
     Input("my_community", "children")])

def update_output2(input2, my_community):
    
    topic = my_community.replace("You belong to ", '').replace(" community!", '')
    
    group_embds = embds_n[str(topic)]
    words = [num[0].translate(str.maketrans('', '', string.punctuation)) for num in group_embds.similar_by_word(str(input2))]
...
@app.callback(
    Output("my_vocab2", "children"),
    [Input("input3", "value"), 
     Input("input4", "value"), 
     Input("my_community", "children")])

def update_output3(input3, input4, my_community):
    
    topic = my_community.replace("You belong to ", '').replace(" community!", '')
    
    group_embds = embds_n[str(topic)]
    words = [num[0].translate(str.maketrans('', '', string.punctuation)) for num in group_embds.most_similar(positive=[input3], negative=[input4])]
